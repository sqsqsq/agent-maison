...
Enforcement: `profiles/hmos-app/harness/hylyre-runtime-telemetry.py`, `harness/scripts/utils/runtime-step-evidence.ts`, `harness/scripts/utils/device-test-evidence-shared.ts`, `profiles/hmos-app/harness/device-test-evidence.ts`, `profiles/hmos-app/harness/providers/device-test-run.ts`, `harness/scripts/utils/phase-evidence-manifest.ts`
