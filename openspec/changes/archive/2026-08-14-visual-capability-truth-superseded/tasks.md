...
- [x] 6.4 locator 终态诊断（七类分母 + 覆盖率落盘 WARN）—— **2026-08-12 重开**：七类规格正文正确，
      ...
      规格正文无需扩写，本项只补接线。
      （2026-08-14 完成：七类齐 + nav/attest 按屏隔离 + within.by_id 递归提取 +
      interactive 回退仅 nav 缺失时启用；T8/calibrate/runtime-mount 同一收窄分母口径。）
