...
> **领域填充实例（具体模块名与业务词见 profile）**：`` `profile-skill-asset:0-catalog-bootstrap/examples_wallet_domain` ``。
...
> **领域填充实例**：`` `profile-skill-asset:0-catalog-bootstrap/examples_wallet_domain` ``。
