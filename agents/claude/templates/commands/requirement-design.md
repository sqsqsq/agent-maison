---
description: 进入技术设计阶段（requirement-design）
...
完整 Skill 定义请阅读：**[framework/skills/feature/requirement-design/SKILL.md](../../framework/skills/feature/requirement-design/SKILL.md)**
