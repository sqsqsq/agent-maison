...
function validSample(): Record<string, unknown> {
  return {
    ...
    fail_count: 2,
    warn_count: 1,
    script_report: 'framework/harness/reports/demo/coding/script-report.json',
    merged_report: 'framework/harness/reports/demo/coding/merged-report.md',
    ai_prompt: 'framework/harness/reports/demo/coding/ai-prompt.md',
    summary_json: 'framework/harness/reports/demo/coding/summary.json',
    run_statuses: [{
