...
机器清单：`framework/profiles/hmos-app/skills/skill-assets.yaml`。根 `SKILL.md` 使用 `` `profile-skill-asset:plan/<键>` ``：

| 键 | 相对 `skills/feature/plan/` |
|----|---------------------------------------|
| `plan_template` | `templates/plan-template.md` |
| `design_template` | `templates/plan-template.md`（legacy 别名） |
| `api_spec_template` | `templates/api-spec.md` |
| `data_model_template` | `templates/data-model.md` |
| `example_plan` | `examples/example-plan.md` |
