...
> **使用方式**：coding（Coding）在生成每个 `.ets` 文件之前，对照本手册做一次"自我检查"；写完之后再做一次"自我校对"。
...
2. **单文件 Lint**：立刻跑一遍单文件的 lint 检查（见 `framework/skills/feature/coding/SKILL.md` Step 3 的"逐文件 Lint 门禁"）。
