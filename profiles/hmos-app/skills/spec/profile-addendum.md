...
- `ref-elements` 中 `disposition: defer` 可在 spec Visual Handoff 块登记 `fidelity_deferrals` 作披露；pixel_1to1/P0 下它始终是未满足的 strict 义务，legacy `human_signed`/`signed_by` 不放行。
