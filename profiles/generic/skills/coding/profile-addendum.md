# `generic` · Skill `coding` profile addendum
...
`framework/skills/feature/coding/SKILL.md` 内指向 `framework/profiles/hmos-app/skills/coding/` 的路径，在 `generic` 下仅作**能力说明**；未切 profile 前勿把该树当作当前工程强制 SSOT。
