...
严格遵守 `profile-skill-asset:catalog-bootstrap/module_card_template` 的结构（占位符解析规则见 `framework/skills/README.md` 的 “Profile skill asset protocol” 一节；勿写死某个 profile 的物理路径）。
