...
imports:
  - { symbol: AckResult, from: "<module>/model/AckResult" }

spies:
  - target_class: TaskRemoteApi          # 必须 ∈ contracts.yaml > interfaces[].class
    target_file: <module>/<path>/TaskRemoteApi.ts
    ...
    methods:
      - name: verifyOpen
        params:
          - { name: draft, type_text: "TaskDraft" }
...
fixtures:
  - { name: draftSample, type: "TaskDraft", ts_expr: "..." }
```
