...
| ----------- | --------------------- | ----------- |
| `extensions` | `check-extensions.ts` | 实例扩展 manifest、引用与 adapter bridge 对账；1.1 knowledge/action/binding 由对应 Feature phase 消费；goal 模式作者 prompt 同样注入本阶段扩展输入（plan a7c3e9d2） |
