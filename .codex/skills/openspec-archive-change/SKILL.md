...
1. **If no change name provided, prompt for selection**
   ...
   Run `npm run openspec -- list --json` to get available changes. Ask the user directly in chat to select a change.
...
2. **Check artifact completion status**
   ...
   **If any artifacts are not `done`:**
   ...
   - Ask the user directly in chat to confirm before proceeding
