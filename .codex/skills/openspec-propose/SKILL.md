...
4. **Create artifacts in sequence until apply-ready**
   ...
   Track artifact progress with a short checklist in your reply.
   ...
   c. **If an artifact requires user input** (unclear context):
      - Ask the user directly in chat to clarify
...
- Follow the `instruction` field from `npm run openspec -- instructions` for each artifact type
